...
def setup():
    ...
    sb_namespace = "sb-store-demo-" + str(os.environ.get("RAND"))
    sb_queue = "orders"
...
# Define the path to the YAML template file
template_file = "cronjob.yaml"
...
# Update the YAML template with variables


# updated_yaml_file = update_yaml_template(template_file, conn_str, sb_queue, sb_namespace)

# Apply the Kubernetes job
# apply_kubernetes_job(updated_yaml_file)
...
if __name__ == "__main__":
    main()
>>>>>>> 286d385107625b23ee4d40186c740ddccdc828ef
